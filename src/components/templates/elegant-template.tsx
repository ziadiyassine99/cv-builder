    ...
    <div className="min-h-[297mm] text-[11px] leading-relaxed bg-white">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-[34px] font-bold text-white tracking-wide leading-tight">
            {pi.firstName} {pi.lastName}
          </h1>
          {pi.jobTitle && (
            <p className="text-[20px] text-white/70 mt-1 tracking-wide">
              {pi.jobTitle}
            </p>
          )}
          ...
          <div className="flex items-center gap-5 mt-3">
            {pi.email && (
              <span className="text-white/85 text-[14px] flex items-center gap-1.5">
